...
const LoggedExerciseSet = ({ set }: Props) => {
    return (
        <div className='bg-black/20 border-b-2 border-muted-foreground/30 flex justify-between'>
            ...
            <div className='flex'>
                <Button title='Edit set' variant='edge' className='hover:bg-blue-500 rounded-none'>
                    <PencilIcon className='w-4 h-4' />
                </Button>
                <Button title='Delete set' variant='edge' className='hover:bg-red-500 rounded-none'>
